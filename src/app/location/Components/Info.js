...
function Info() {
  ...
  return (
    <div className='bg-[#AB8456] w-full h-[171px] flex flex-row items-center py-2 px-3 absolute top-[990.58px] left-0 '>
      ...
      <div className='w-[921.74px] flex items-center justify-center px-12 '>
