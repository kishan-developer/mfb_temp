...
function Content_4({ data }) {

    console.log("data", data);

    return (
        <div className='w-full mt-[10px] h-[60vh] bg-[#F7F3E8] text-[#3C4617] flex flex-col items-center justify-center text-center'>

            {/* <div className='w-auto flex items-center justify-center'>
                <img src='./path20.png' />
            </div>

            <div className='w-[700px] h-[auto] p-5 '>

                <h3
                    className="text-[#3C4617] text-[42px] font-bold  font-[poppins]">
                    The Dawn of Well-Living
                </h3>

                <p className='font-[300] py-7 leading-6 font-[Spezia]'>
                ...
                <h3 className="text-[#3C4617] text-[30px] font-bold font-[poppins]">PRICES STARTING FROM AED 43,000,000</h3>
            </div>

            <div className='flex items-center justify-between gap-5 leading-9'>
                <button className='w-[250px] border-[1px] border-[#AB8456] text-[#AB8456] text-[14px] leading-8'>
